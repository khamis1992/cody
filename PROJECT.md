# Project management of Code Launch
...
> tl;dr: We've got a project board with epics and features. We use PRs as change log and as materialized features. Find it [here](https://github.com/khamis1992/cody/projects).
...
You can find the [epics as issues](https://github.com/khamis1992/cody/labels/epic) which are probably never
going to be closed.
